...
class BoardTestSuite {
    ...
    void testAddTaskListAverageWorkingOnTask() {
        ...
        long tasksSum = project.getTaskLists().stream()
                .filter(inProgressTasks::contains)
                .flatMap(tl -> tl.getTasks().stream())
                .map(Task::getCreated)
                .mapToLong(td -> LocalDate.now().getDayOfYear()-td.getDayOfYear())
                .sum();
        ...
        long tasksNumber = project.getTaskLists().stream()
                ...
                .flatMap(tl -> tl.getTasks().stream())
                .count();
        long result = tasksSum / tasksNumber;

        //Then
        System.out.println("Sum: "+tasksSum);
        System.out.println("Count: "+tasksNumber);
